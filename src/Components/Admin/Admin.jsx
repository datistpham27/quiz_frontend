...
const Admin = (props) => {
  const array_link= useMemo(()=> [{link: "", text: "Explore", icon: <ExploreIcon></ExploreIcon>, component: <Explore></Explore>},{link: "private", text: "My library", icon: <ClassIcon></ClassIcon>, component: <MyLibrary></MyLibrary>}, {link: "report", text: "Report", icon: <EqualizerIcon></EqualizerIcon>, component: <Report></Report>}, {link: "setting", text: "Setting", icon: <SettingsIcon></SettingsIcon>, component: <Setting></Setting>}, {link: "profile", text: "Profile", icon: <AccountCircleIcon></AccountCircleIcon>, component: <Profile></Profile>}, {link: "logout", text: "Log out", icon: <LogoutIcon></LogoutIcon>, component: <></>}], [])
