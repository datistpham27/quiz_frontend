...
const Option= (props)=> {
    ...
    return (
        <div className="option-2">
            <div className="w-option2" onClick={()=> setOpen(prev=> !prev)}>
                <ShareIcon></ShareIcon>
            </div>
            {
                open=== true &&
...
export const MainShare= (props)=> {
    ...
    return (
        <div className="main-share" style={{top: props?.open=== true ? "50%" : "-100%"}}>
            ...
            <Share2 link={`http://localhost:3000/term/${data?.get_term?.id_term}/${data?.get_term?.title}`}></Share2>
    ...
    return (
        <>
            <div className="btn-share">
                <FacebookShareButton
                    url={"http://localhost:3000/term/293203421/k"}
